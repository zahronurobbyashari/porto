  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">
        Explore my projects to see how I design and build innovative solutions,
        deliver high-quality software, and showcase my problem-solving skills.
      </p>
      <p className="home__description">
        Discover my expertise in testing and validating software, ensuring
        excellence and reliability in every project.
      </p>
